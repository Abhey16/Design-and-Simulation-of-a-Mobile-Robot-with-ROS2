...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    xacro_file = "mobile_robot.urdf.xacro"

    package_description = "mobile_robot"

    # Position and orientation
    # [X, Y, Z]
   # position = [1.3, -3.0, 0.5] # Spawn in competition
    position = [0.0, 0.0, 0.5] # Spawn at 0,0


    # [Roll, Pitch, Yaw]
    #orientation = [0.0, 0.0, -1.503] #Spawn in competition
    orientation = [0.0, 0.0, 0.0] # Spawn at 0,0
    # Base Name or robotoo
    robot_base_name = "mobile_robot"
    ####### DATA INPUT END ##########
